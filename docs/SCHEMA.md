...
Project State is a separate evidence class with its own strict machine-readable contract at `schema/project-state-reconstruction-1.0.1.schema.json`. It does not alter the existing ChatGPT, Claude, Codex, or GitHub reconstruction formats.
