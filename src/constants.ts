export const GATEWAY_PACKAGE_VERSION = "1.1.0";
...
export const PROJECT_STATE_RECONSTRUCTION_SCHEMA_VERSION = "1.0.0";
...
export const PRIVACY_CONTRACT_COMPATIBILITY = "2.0.0";
