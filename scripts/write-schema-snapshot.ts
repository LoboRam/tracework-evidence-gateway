...
await writeFile(new URL("../schema/project-state-reconstruction-1.0.2.schema.json", import.meta.url), `${JSON.stringify(z.toJSONSchema(projectStateReconstructionPacketSchema), null, 2)}\n`, "utf8");
